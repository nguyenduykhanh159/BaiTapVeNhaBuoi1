...
//    }
    ...
    public DigitalVideoDisc getALuckyItem() {
        ...
        return itemsOrdered[random.nextInt(itemsOrdered.length)];
    }

    public float totalCostWithoutLuckyItem(DigitalVideoDisc discLucky) {
        float costWithFree = 0.0f;
        for (int i = 0; i < qtyOrdered; i++) {
            if (itemsOrdered[i].equals(discLucky) == false) {
                costWithFree += itemsOrdered[i].getCost();
            }
        }
        return costWithFree;
    }
    ...
    public void printOrderedWithoutLuckyItem() {
        ...
        System.out.println("A lucky and free item is disc : " + discLucky.getTitle());
        System.out.println("***********************Order***********************");
        System.out.print("Date : "); dateOrdered.print();
        System.out.println("Order Items : ");
        for (int i = 0; i < itemsOrdered.length; i++) {
        ...
        System.out.println("Total cost : " + totalCostWithoutLuckyItem(discLucky) + "$");
        System.out.println("***************************************************");
    }
}
